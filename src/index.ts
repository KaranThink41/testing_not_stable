...
class GoogleChatServer {
  ...
  constructor() {
    this.server = new Server(
      { name: "google-chat-server", version: "0.3.0" },
      { capabilities: { tools: {} } }
    );
      ...
      tools: [
        {
          ...
          description:
            "Post a text message to a Google Chat space. See: https://developers.google.com/chat/api/reference/rest/v1/spaces.messages/create",
          inputSchema: {
            type: "object",
            properties: {
              spaceId: {
                type: "string",
                description:
                  "The unique ID of the Google Chat space (format: spaces/{spaceId}). Optional if a default is set.",
              },
              text: {
                type: "string",
        ...
        },
        {
          ...
          description:
            "Retrieve membership details from a Google Chat space. See: https://developers.google.com/chat/api/reference/rest/v1/spaces.members/get",
          inputSchema: {
            type: "object",
            properties: {
              spaceId: {
                type: "string",
                description:
                  "The unique ID of the Google Chat space. Optional if default is set.",
              },
              memberId: {
                type: "string",
        ...
        },
        {
          ...
          description:
            "Get detailed information about a specific Google Chat space. See: https://developers.google.com/chat/api/reference/rest/v1/spaces/get",
          inputSchema: {
            type: "object",
            properties: {
              spaceId: {
        ...
        },
        {
          ...
          description:
            "List all memberships in a Google Chat space with roles and status. See: https://developers.google.com/chat/api/reference/rest/v1/spaces.members/list",
          inputSchema: {
            type: "object",
            properties: {
              spaceId: {
              ...
              pageSize: {
                type: "number",
                description:
                  "Maximum number of memberships to return (default is 100).",
              },
              pageToken: {
                type: "string",
        ...
        },
        {
          ...
          description:
            "Retrieve messages from a Google Chat space. Supports advanced filtering such as keywords, date ranges, usernames, deleted messages, and attachments. See: https://developers.google.com/chat/api/reference/rest/v1/spaces.messages/list",
          inputSchema: {
            type: "object",
            properties: {
              spaceId: {
              ...
              orderBy: {
                type: "string",
                description:
                  "Ordering (e.g., 'createTime' or 'lastUpdateTime').",
                enum: ["createTime", "lastUpdateTime"],
              },
              filter: {
                type: "string",
                description:
                  "Filter messages (by date, keyword, username, deleted state, attachments, etc.).",
              },
              showDeleted: {
                type: "boolean",
        ...
        },
        {
          ...
          description:
            "Get detailed information about a specific message. See: https://developers.google.com/chat/api/reference/rest/v1/spaces.messages/get",
          inputSchema: {
            type: "object",
            properties: {
              spaceId: {
        ...
        },
        {
          ...
          description:
            "List all Google Chat spaces that the caller is a member of. See: https://developers.google.com/chat/api/reference/rest/v1/spaces/list",
          inputSchema: {
            type: "object",
            properties: {
              pageSize: {
        ...
        },
        {
          ...
          description:
            "Convert a natural language filter (e.g., 'Monday', 'Rahul message', 'files uploaded last month', 'link', 'deleted', 'image', etc.) into standardized query parameters.",
          inputSchema: {
            type: "object",
            properties: {
              filterText: {
        ...
        },
        {
          ...
          description:
            "Create a new Google Chat space. Note: This is simulated since the API might not allow direct space creation.",
          inputSchema: {
            type: "object",
            properties: {
              spaceName: {
        ...
        },
        {
          ...
          description:
            "List files shared in a Google Chat space with advanced filtering by date, type, size, etc. (Simulated response.)",
          inputSchema: {
            type: "object",
            properties: {
              spaceId: {
        ...
        },
        {
          ...
          description:
            "Monitor a Google Chat space for new members and send a DM with details to a specified manager email.",
          inputSchema: {
            type: "object",
            properties: {
              spaceId: {
        ...
        },
        {
          ...
          description:
            "Analyze and summarize messages in a Google Chat space based on dynamic criteria. For example, get your manager’s message summary from yesterday, what Rahul typed in the last 5 days, list deleted messages, extract image content details, etc. This tool applies multiple filters (date ranges, usernames, keywords, deleted state, attachments) to produce a dynamic summary.",
          inputSchema: {
            type: "object",
            properties: {
              spaceId: {
              ...
              username: {
                type: "string",
                description:
                  "Optional username (or part of the display name) to filter messages (e.g., 'Rahul', 'manager').",
              },
              timeRange: {
                type: "string",
                description:
                  "Time range filter in natural language (e.g., 'yesterday', 'last 5 days').",
              },
              summaryType: {
                type: "string",
                description:
                  "Type of summary: 'content', 'deleted', 'attachments', 'images', etc.",
              },
              includeImages: {
                type: "boolean",
                description:
                  "Set to true to analyze image content (simulated analysis).",
              },
            },
            required: ["timeRange"],
          },
  ...
  private async handleGetMember(args: any): Promise<any> {
    try {
      const spaceId = this.getSpaceId(args);
      const { memberId } = args;
  ...
  private async handleGetSpace(args: any): Promise<any> {
    try {
      const spaceId = this.getSpaceId(args);
  ...
  private async handleListMembers(args: any): Promise<any> {
    try {
      const spaceId = this.getSpaceId(args);
    ...
    try {
      ...
      if (filter) {
        ...
        if (
          ...
          finalFilter = conversionResult.content[0].text.replace(
            "Converted filter: ",
            ""
          );
        }
  ...
  private async handleGetMessage(args: any): Promise<any> {
    try {
      const spaceId = this.getSpaceId(args);
  ...
  private async handleListSpaces(args: any): Promise<any> {
    try {
  ...
  private async handleApplyNaturalLanguageFilter(args: any): Promise<any> {
    try {
  ...
  private async handleCreateChatSpace(args: any): Promise<any> {
    try {
  ...
  private async handleListSharedFiles(args: any): Promise<any> {
    try {
      const spaceId = this.getSpaceId(args);
  ...
  private async handleMonitorNewMembers(args: any): Promise<any> {
    try {
      const spaceId = this.getSpaceId(args);
  ...
  private async handleAnalyzeUserMessages(args: any): Promise<any> {
    try {
      const spaceId = this.getSpaceId(args);
