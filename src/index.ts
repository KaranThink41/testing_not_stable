...
class GoogleChatServer {
  ...
  private async handleCreateMessage(args: any) {
    try {
  ...
  private async handleGetMember(args: any) {
    try {
  ...
  private async handleListMembers(args: any) {
    try {
  ...
  private async handleApplyNaturalLanguageFilter(args: any) {
    try {
